            ...
            <form onSubmit={handleSubmit} className="p-4 border rounded-lg space-y-4 bg-gray-50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select id="siteSelect" value={selectedSiteId} onChange={e => setSelectedSiteId(e.target.value)} required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white">
                    ...
                    <div>
                        ...
                        <input type="text" id="anchorName" value={anchorName} onChange={e => setAnchorName(e.target.value)} required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white text-gray-900"/>
                    </div>
                    <div>
                    ...
                    <div>
                     ...
                     <div className="md:col-span-2 flex flex-col sm:flex-row sm:items-center gap-4 pt-2">
                        <div className="flex items-center gap-2">
                            <input type="checkbox" id="isDeepwater" checked={isDeepwater} onChange={e => setIsDeepwater(e.target.checked)} className="h-4 w-4 rounded border-gray-300 text-coral-blue focus:ring-coral-blue"/>
                        ...
                        {isDeepwater && (
                            <div className="flex-grow">
                                ...
                                <input type="number" step="any" id="depth" value={depth} onChange={e => setDepth(e.target.value)} required={isDeepwater} placeholder="Enter depth in meters" className="block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white text-gray-900"/>
                            </div>
                        )}
                    </div>
                </div>
