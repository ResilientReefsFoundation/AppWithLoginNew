                    ...
                    {selectedTreeId && (
                        <div>
                            ...
                            <div className="flex justify-end mt-4">
                                <button onClick={() => onAddFloat(selectedTreeId)} className="bg-coral-green text-coral-dark font-bold py-2 px-4 rounded-lg">
                                    Add New Float
                                </button>
                            </div>
                        </div>
                            ...
                            {treesOnSelectedSite.length > 0 ? treesOnSelectedSite.map(tree => {
                                ...
                                return (
                                    <li key={tree.id} className="p-3 flex justify-between items-center">
                                        ...
                                        <button onClick={() => onAddFloat(tree.id)} className="bg-coral-green text-coral-dark font-bold py-1 px-3 rounded-lg text-sm">
                                            + Add Float
                                        </button>
                                    </li>
                                );
