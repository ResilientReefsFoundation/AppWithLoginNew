...
export const TrashIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path fillRule="evenodd" d="M16.5 4.478v.227a48.816 48.816 0 0 1 3.878.512.75.75 0 1 1-.256 1.478l-.209-.035-1.005 13.006a.75.75 0 0 1-.742.742H5.654a.75.75 0 0 1-.742-.742L3.91 6.66l-.209.035a.75.75 0 0 1-.256-1.478A48.567 48.567 0 0 1 7.5 4.705v-.227c0-1.564 1.213-2.9 2.816-2.9h1.368c1.603 0 2.816 1.336 2.816 2.9ZM5.158 21.5h13.684a2.25 2.25 0 0 0 2.242-2.13l1.02-13.256a.75.75 0 0 0-.74-..833H3.633a.75.75 0 0 0-.74.833l1.02 13.256A2.25 2.25 0 0 0 5.158 21.5Z" clipRule="evenodd" />
  </svg>
);
...
export const CameraIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    ...
    <path fillRule="evenodd" d="M9.344 3.071a49.52 49.52 0 0 1 5.312 0c.967.052 1.83.585 2.342 1.372a.75.75 0 0 1-.216 1.063l-.884.663-1.8-1.35a.75.75 0 0 0-.936.108L11.5 7.5H12.5a.75.75 0 0 1 0 1.5H11.5a.75.75 0 0 0-.75.75v1.5a.75.75 0 0 1-1.5 0v-1.5a.75.75 0 0 0-.75-.75H7.5a.75.75 0 0 1 0-1.5h.5l-1.838-2.185a.75.75 0 0 0-.936-.108l-1.8 1.35-.884-.663a.75.75 0 0 1-.216-1.063A3.07 3.07 0 0 1 9.344 3.071ZM2.25 9.75A3 3 0 0 0 0 12.75v6A3 3 0 0 0 3 21.75h18A3 3 0 0 0 24 18.75v-6a3 3 0 0 0-2.25-3H2.25Z" clipRule="evenodd" />
  </svg>
);
...
export const DatabaseIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 0 1-9-9h9v9Z" />
...
export const MicrophoneIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    ...
    <path d="M6 15a.75.75 0 0 0-.75.75 4.5 4.5 0 0 0 4.5 4.5v1.5a.75.75 0 0 0 1.5 0v-1.5a4.5 4.5 0 0 0 4.5-4.5.75.75 0 0 0-1.5 0 3 3 0 0 1-3 3 3 3 0 0 1-3-3A.75.75 0 0 0 6 15Z" />
  </svg>
);
...
export const Square2StackIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 0 1 1.5-1.5H5.625a2.25 2.25 0 0 0-2.25 2.25v12A2.25 2.25 0 0 0 5.625 21h9.75A2.25 2.25 0 0 0 17.625 18.75V17.25ZM16.5 5.25h3.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125V13.5m0-6.375a3.375 3.375 0 0 0-3.375-3.375H8.25V5.25a3.375 3.375 0 0 0 3.375 3.375h5.25Z" />
    </svg>
);

export const ThermometerIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.375v11.25m3-11.25V5.25a2.25 2.25 0 0 0-4.5 0v1.125m3 11.25a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
    </svg>
);
...
export const HomeIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
      ...
      <path d="m12 5.432 8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75V18a.75.75 0 0 1-.75.75H5.625a1.875 1.875 0 0 1-1.875-1.875v-6.198a2.29 2.29 0 0 0 .091-.086L12 5.432Z" />
    </svg>
);
...
export const GlobeAltIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.95-8.034.996.996 0 0 0-1.949-.193h-.306a6.748 6.748 0 0 1-1.341-3.612 6.748 6.748 0 0 1 3.612-1.341h.306c.553 0 .998-.445 1.006-.997A9.005 9.005 0 0 0 12 3c-4.968 0-9 4.032-9 9s4.032 9 9 9Z" />
    </svg>
);

export const BeakerIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.087c0-1.721-.937-3.21-2.25-4.017-1.313-.807-2.937-.807-4.25 0C6.437 2.877 5.5 4.366 5.5 6.087v8.613c0 .85.34 1.634.9 2.21l4.2 4.2c.57.57 1.349.9 2.15.9h.2c.8-.001 1.58-.332 2.15-.9l4.2-4.2c.56-.576.9-1.36.9-2.21V6.087a4.5 4.5 0 00-2.25-3.923" />
