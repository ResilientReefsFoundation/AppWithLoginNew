...
const LoginPage: React.FC<LoginPageProps> = ({ users, onSignUp, onLogin, onVerifyEmail, onApproveUser, onDevLogin }) => {
    ...
    const renderContent = () => {
        switch(view) {
            case 'verify_email':
                return (
                    <div className="text-center">
                        <h2 className="text-2xl font-bold text-coral-dark mb-2">Check Your Email</h2>
                        ...
                        <button 
                            ...
                            className="w-full bg-coral-green hover:bg-opacity-90 text-coral-dark font-bold py-3 px-4 rounded-lg transition-colors duration-200"
                        >
            ...
            case 'awaiting_approval':
                 return (
                    <div className="text-center">
                        <h2 className="text-2xl font-bold text-coral-dark mb-2">Email Verified!</h2>
            ...
            case 'approved':
                return (
                    <div className="text-center">
                        <h2 className="text-2xl font-bold text-coral-dark mb-2">Account Approved!</h2>
                        <p className="text-gray-600 mb-6">You can now log in to the application.</p>
                        <button 
                            onClick={() => { setView('login'); setPendingUser(null); }}
                            className="w-full bg-coral-blue hover:bg-opacity-90 text-white font-bold py-3 px-4 rounded-lg transition-colors duration-200"
                        >
                           Go to Login
                        </button>
                    </div>
            ...
            default:
                return (
                     <form onSubmit={handleSubmit} className="space-y-6">
                        <h2 className="text-3xl font-bold text-center text-coral-dark">{view === 'login' ? 'Welcome Back' : 'Create Account'}</h2>
                        <div>
                            ...
                            <div className="mt-1">
                                <input
                                    ...
                                    className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-coral-blue focus:border-coral-blue sm:text-sm bg-white text-gray-900"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            <button
                                type="submit"
                                className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-coral-blue hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-coral-blue"
                            >
                         ...
                         <div className="text-center text-sm">
                            <button
                                ...
                                className="font-medium text-coral-blue hover:text-opacity-80"
                            >
    ...
    return (
        <div className="min-h-screen bg-coral-sand flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                 <h1 className="text-center text-4xl font-bold tracking-tight text-coral-green">Coral Nursery Monitor</h1>
            </div>
            ...
            <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-md">
                 <button
                    onClick={onDevLogin}
                    className="w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-coral-blue"
                >
                    Access as Dev User
                </button>
            </div>
