    ...
    return (
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg space-y-8">
            <div className="flex flex-col sm:flex-row justify-between sm:items-center border-b pb-4">
                <h2 className="text-2xl font-bold text-coral-dark mb-2 sm:mb-0">Move Items</h2>
                <button
            ...
            <form onSubmit={handleMoveTreeSubmit} className="p-4 border rounded-lg space-y-4 bg-gray-50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                    <div>
                        ...
                        <select id="treeToMove" value={moveTreeId} onChange={e => setMoveTreeId(e.target.value)} required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white text-gray-900">
                    ...
                    <div>
                        ...
                        <select id="newAnchor" value={newAnchorId} onChange={e => setNewAnchorId(e.target.value)} required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white text-gray-900">
            ...
            <form onSubmit={handleMoveBranchSubmit} className="p-4 border rounded-lg space-y-4 bg-gray-50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="md:col-span-2">
                        ...
                        <select id="branchToMove" value={moveBranchId} onChange={e => setMoveBranchId(e.target.value)} required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white text-gray-900">
