...
import { CloseIcon, PencilIcon, ClipboardListIcon, DatabaseIcon, ChartBarIcon, BookOpenIcon, ArchiveBoxIcon, PencilSquareIcon, HeartPulseIcon, Square2StackIcon, ThermometerIcon, HomeIcon, BeakerIcon, TrendingUpIcon, ArrowRightOnRectangleIcon } from './Icons';
...
const SideMenu: React.FC<SideMenuProps> = ({ isOpen, onClose, onNavigateToAddEdit, onNavigateToPage, onLogout }) => {
      ...
      >
        <div className="flex flex-col h-full">
          <header className="p-4 flex justify-between items-center border-b">
            <h2 id="menu-title" className="text-lg font-bold text-coral-dark">Menu</h2>
          ...
          <nav className="flex-grow p-4 space-y-1 overflow-y-auto">
              <button
                ...
                className="w-full flex items-center gap-3 p-3 rounded-lg text-left text-coral-dark hover:bg-coral-blue/10 transition-colors"
              >
          ...
          <div className="p-4 border-t">
             <button
                onClick={onLogout}
                className="w-full flex items-center gap-3 p-3 rounded-lg text-left text-coral-dark hover:bg-red-500/10 hover:text-red-600 transition-colors"
              >
